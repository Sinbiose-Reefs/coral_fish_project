...
samples_OCCcoral_PdepthTime_longo <- parLapply (cl,seq(1,length(df_fish_data_per_coral)), function (coral) {
    ...
    samples <- jags(data = jags.data, 
                    params, 
                    model = here ("bugs_models","StaticModel_LONGO_comm_NoReg_reviewed.txt"), 
                    inits = inits,
                    n.chains = nc, 
                    n.thin = nt, 
                    n.iter = ni, 
...
save(samples_OCCcoral_PdepthTime_longo, 
     file=here("output","samples_OCCcoral_PdepthTime_longo.RData"))
...
save(samples_OCCcoral_PdepthTime_longo_RdmP, 
     file=here("output","samples_OCCcoral_PdepthTime_longo_RdmP.RData"))
