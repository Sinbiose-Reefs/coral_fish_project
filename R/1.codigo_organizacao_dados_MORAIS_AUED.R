...
## filtrar os dados de peixes de UVC de acordo com o minimo de ano de bentos
...
save (arranjo_corais, ### dados de cobertura 
      ...
      file=here ("output","Data_coral_detection_MORAIS_AUED.RData"))

### salvar os dados para o modelo de ocupacao dos peixes

save (subset_peixes,## arranjo com subset dos peixes com dados corespondendo aos corais
      ...
      file = here("output", "Data_fish_detection_MORAIS_AUED.RData"))
